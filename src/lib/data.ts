...
export const PROJECTS = [
  ...
  },
  {
    ...
    subtitle: 'Vision-Language Models · EXIF Forensics · Ollama · HackerRank Orchestrate',
    blurb: 'A damage-claim verification system decomposed into claim-blind perception, a forensic EXIF layer, and policy-driven adjudication.',
    description: 'A damage-claim verification system built for a timed hackathon (~20-hour build window, HackerRank Orchestrate). Decomposed the problem into claim-blind per-image perception feeding a policy engine and adjudication stage, rather than one monolithic VLM call. The differentiator was a deterministic forensic layer (EXIF analysis) that escalates scrutiny on edited images instead of auto-rejecting them, since edit signals appeared on both fraudulent and legitimate claims in the data. Model-agnostic architecture; used local Ollama models for all development and a frontier model only for the final scored output. Handled multilingual claims (English, Hindi, Hinglish, Spanish) and included prompt-injection defenses.',
    metrics: [
      { label: 'Build window', value: '~20 hrs' },
      { label: 'Claim languages', value: '4' },
      { label: 'Dev models', value: 'Local Ollama' },
    ],
    tags: ['Vision-Language Models', 'Multi-Modal AI', 'Forensic Analysis', 'Ollama', 'Hackathon'],
    github: null,
    demo: null,
    featured: false,
    category: 'Hackathon / Multi-Modal AI',
    year: '2026',
    mockupKind: 'terminal',
    tint: 'plum',
  },
